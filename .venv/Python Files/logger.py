...
mqttc.subscribe("zigbee2mqtt/Lys/2_Etg/#", 0)
mqttc.publish(topic="zigbee2mqtt/Lys/2_Etg/Kontor/set", payload = "OFF")

mqttc.loop_forever()

#publish.single("zigbee2mqtt/Lys/2_Etg/Kontor/set", "OFF", hostname="192.168.1.50")